...
class DetailsCourse extends StatelessWidget {
  const DetailsCourse({
    ...
    required this.coursetitle,
      this.categoryimage,
     this.regusterednum,
    required this.canreguster, required this.categoryname, required this.startDate, required this.endDate, this.location, required this.state, required this.price, required this.desc, required this.tranername, required this.courseId, 
  });
final String desc; 
...
final double price;  
  ...
  Widget build(BuildContext context)  {
       final toget=  GetIt.I.get<OpreationsLayer>().getDetailes(courseId: courseId);
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 12),
                CourseInfo(
                  categoryimage: categoryname=="Cook"?"assets/images/Clean (2).png":"assets/images/cook (2).png",

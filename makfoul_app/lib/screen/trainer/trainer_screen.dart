    ...
    return BlocProvider(
      ...
      child: Builder(
        builder: (context) {
          ...
          Future.delayed(Duration.zero,(){bloc.add(UpdateSearchQuery(searchtext:'' , toserch: courses));});
          return Scaffold(
            appBar: AppBar(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return Padding(
                            ...
                            child: InstructorCustomCard(
                              ...
                              trainerName: coursestoshow[index].price.toString(),
                                ...
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) => CourseView(
                                      ...
                                      numberOfTrainees:
                                          courses[index].numberOfTrainees,
